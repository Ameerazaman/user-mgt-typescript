                        ...
                        <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                            ...
                            <form onSubmit={submitForm} className="space-y-4 md:space-y-6" action="#" method='post'>
                                ...
                                <div>
                                    ...
                                    <span className="text-red-500 dark:text-red-300">{confirmErr}</span>
                                ...
                                <p className="text-sm font-light text-gray-500 dark:text-gray-400">
                                    you have an account? <a href="/" className="font-medium text-primary-600 hover:underline dark:text-primary-500">Sign up</a>
                                </p>
                            </form>
                        </div>
                    </div>
